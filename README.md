...
- **mobile/** — Flutter app covering employee self-service essentials (attendance, tasks, documents, KPI, exams, location-based issue reporting, announcements, notifications). Admin/HR/management screens stay web-only. See [`mobile/README.md`](mobile/README.md) for scope and setup.
